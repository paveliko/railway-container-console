...
- [x] **T-SV-1 Split the fixture directory.** Result: the ten design fixtures
...
- [x] **T-SV-2 Reader, parsers, structured problems.** Result:
...
- [x] **T-SV-3 `R-STRUCT`, `R-ID`.** Result: the two rules and their red and
...
- [x] **T-SV-4 `R-REF` and the example convention.** Result: the rule, the
  ...
  the convention.*
- [x] **T-SV-5 `R-TRACE`.** Result: the reachability query, the cycle report,
...
- [x] **T-SV-6 `R-LINK`, `R-VOCAB`.** Result: the two rules and their fixtures.
  Depends on: T-SV-5. Acceptance: V-SV-9, V-SV-10. Verified by:
  `pnpm check:specs:self-test`.
- [x] **T-SV-7 The four warnings.** Result: `W-CLAIM`, `W-CRED`, `W-FILE`,
  ...
  Verified by: `pnpm check:specs:self-test`.
- [x] **T-SV-8 The corpus findings.** Result: the register and corpus edits the
...
- [x] **T-SV-9 Wiring.** Result: `check:specs` and `check:specs:self-test` in
...
- [x] **T-SV-10 Break-and-revert.** Result: six logged procedures, one per error
