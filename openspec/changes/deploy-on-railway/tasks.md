...
- [~] **T-DR-3 Console service.** *Owner deploys, agent prepares.* Parent T-7.2. Acceptance: V-DR-1, V-DR-2, V-DR-3, `V-52`, `V-54`, `V-55`.
- [~] **T-DR-4 Cycle once, by hand.** *Owner.* Parent T-7.3: `V-50`, `V-51` with screenshots in the PR.
