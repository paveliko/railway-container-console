...
| [`2026-09-14-experiment-stop-and-start.md`](2026-09-14-experiment-stop-and-start.md) | **The `Q-API-6` experiment.** A real container started, stopped, restarted and stopped again: what `deploymentStop` leaves behind, why the subscription cannot see it, why a project token cannot subscribe, and why `numReplicas: 0` is not an option |
| [`experiment-2026-09-14/`](experiment-2026-09-14/) | The raw frames behind that document, unedited |
...
| the API — confirmed capabilities and limits | `2026-09-14-railway-public-api.md`, `2026-09-14-railway-graphql-surface.md`, `railway-schema-excerpt.graphql`, `2026-09-14-railway-operations-and-cost.md`, and **`2026-09-14-experiment-stop-and-start.md`** for what was proven against a live service |
