...
export interface PollerOptions {
  /**
   * The port, not a bare function: the poller is the domain's only consumer of
   * Railway, and naming the seam `ContainerProvider` is what lets the adapter
   * live in a package this one does not depend on (`V-MW-12`).
   */
