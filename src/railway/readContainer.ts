...
import type { ContainerView, DeploymentView } from '../container/state';
import type { DeploymentInstanceStatus, DeploymentStatus } from './types';

interface ReadServiceInstanceData {
  serviceInstance: {
