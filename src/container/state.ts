...
import type { DeploymentInstanceStatus, DeploymentStatus } from '../railway/types';
...
export type DownReason = 'never-deployed' | 'stopped' | 'removed';

export type ContainerState =
  | { phase: 'down'; reason: DownReason }
